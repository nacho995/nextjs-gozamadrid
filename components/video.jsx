...
const Video = () => {
    ...
    // Efecto mejorado para la configuración del video - CORREGIDO
    useEffect(() => {
        ...
        // Inicializar carga del video - SIN CAMBIOS DE ESTADO QUE CAUSEN CICLOS
            ...
            try {
                ...
                if (playPromise !== undefined) {
                    playPromise.catch(error => {
                        // Autoplay bloqueado - no es crítico
                    });
                }
            } catch (error) {
    ...
    }, [isClientHydrated]); // SOLO isClientHydrated - sin videoSrc ni retryCount
    ...
    // Efecto para seleccionar la primera propiedad cuando se cargan - CORREGIDO
    useEffect(() => {
    ...
    }, [allProperties.length]); // SOLO length, no selectedProperty ni meta
    ...
    // Efecto para actualizar el mapa cuando se abra el modal - CORREGIDO
    useEffect(() => {
        if (showMap) {
            // Simplemente limpiar selección al abrir el mapa
            setSelectedProperty(null);
        }
    }, [showMap]); // Solo showMap, sin dependencias complejas
                                            ...
                                            <div className="grid grid-cols-1 lg:grid-cols-5 gap-4">
                                                ...
                                                <div>
                                                    <button
                                                        ...
                                                        disabled={!isHydrated || propertiesLoading}
                                                        type="button"
