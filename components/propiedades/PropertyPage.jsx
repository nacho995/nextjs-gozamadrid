...
import { formatPrice, normalizePropertyPrice } from '@/utils/priceFormatter';
  ...
  const generatePropertyListSchema = () => {
    ...
    return {
      ...
      "itemListElement": allProperties.map((property, index) => {
        ...
        // Extraer precio usando la utilidad centralizada
        let price = "Consultar";
        let priceValue = null;
        
        if (property.price) {
          // Usar la utilidad centralizada para obtener el precio formateado
          price = formatPrice(property.price);
          // Obtener valor numérico para schema.org
          priceValue = normalizePropertyPrice(property).price;
        }
    ...
    return (
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {currentProperties.map((property, index) => {
          ...
          // Obtener precio formateado usando la utilidad centralizada
