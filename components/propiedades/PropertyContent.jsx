...
import { formatPrice, generateOfferRanges as generateOfferRangesUtil, normalizePropertyPrice } from '@/utils/priceFormatter';
...
export default function DefaultPropertyContent({ property }) {
  ...
  // Usar la utilidad centralizada para generar rangos de ofertas
  const generateOfferRanges = (priceValue) => {
    return generateOfferRangesUtil(priceValue);
  };
  ...
  // Formatear precio usando la utilidad centralizada
  let formattedPrice = 'Consultar precio';
  if (propertyState.price) {
    formattedPrice = formatPrice(propertyState.price);
  }
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <div className="space-y-3">
                    {generateOfferRanges(propertyState.price).map((range, index) => (
                      <button
                        key={index}
                      ...
                      >
                        ...
                        <span className="font-semibold">{range.formatted}</span>
                      </button>
                    ))}
                  </div>
                </div>
