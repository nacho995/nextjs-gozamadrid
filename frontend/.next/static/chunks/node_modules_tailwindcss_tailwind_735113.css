...
.via-amarillo {
  --tw-gradient-to: #c7a33600 var(--tw-gradient-to-position);
  --tw-gradient-stops: var(--tw-gradient-from), #c7a336 var(--tw-gradient-via-position), var(--tw-gradient-to);
}
...
.hover\:bg-bluecolor:hover {
  --tw-bg-opacity: 1;
  background-color: rgb(0 7 82 / var(--tw-bg-opacity, 1));
}
...
@media (prefers-color-scheme: dark) {
  ...
  .dark\:hover\:shadow-gray-700:hover {
    --tw-shadow-color: #374151;
    --tw-shadow: var(--tw-shadow-colored);
  }
