...
const ENDPOINTS = {
  ...
  BACKEND: {
    BASE: config.API_ROUTES?.RENDER || 'https://nextjs-gozamadrid.fly.dev',
    HEALTH: `${config.API_ROUTES?.RENDER || 'https://nextjs-gozamadrid.fly.dev'}/health`,
    ROOT: (config.API_ROUTES?.RENDER || 'https://nextjs-gozamadrid.fly.dev').replace('/api', ''),
    ALTERNATE: {
