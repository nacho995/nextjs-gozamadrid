            ...
            try {
                ...
                if (wpResponse.ok) {
                    ...
                    if (wpData && Array.isArray(wpData)) {
                        ...
                        // Agregar logging para diagnosticar problemas con imágenes
                        if (wpData.length > 0) {
                            console.log('Muestra del primer blog para debug:', {
                                id: wpData[0].id,
                                title: wpData[0].title?.rendered || 'Sin título',
                                has_embedded: !!wpData[0]._embedded,
                                embedded_keys: wpData[0]._embedded ? Object.keys(wpData[0]._embedded) : [],
                                featured_media: wpData[0].featured_media,
                                featured_media_url: wpData[0].featured_media_url,
                                first_embedded_media: wpData[0]._embedded?.['wp:featuredmedia']?.[0]
                            });
                        }
