    ...
    return (
        <AnimatedOnScroll>
            <div className="container mx-auto px-4 py-12">
                ...
                >
                    <h1 className="text-4xl md:text-5xl font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-black via-amarillo to-black">
                        Reformas Sin Obras
                    </h1>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20">
                    <motion.div
                        ...
                        className="bg-white/5 backdrop-blur-sm p-8 rounded-xl shadow-lg"
                    >
                ...
                <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
                    className="bg-white/5 backdrop-blur-sm p-8 rounded-xl shadow-lg mb-20"
                >
                ...
                {/* Sección de Tipos de Habitaciones Expandida */}
