...
export default function Agreements() {
    return (
        ...
        <div className="relative w-full min-h-[80vh] pb-[10vh] overflow-hidden bg-white">
            ...
            <div className=" z-[110] h-[40vh] flex flex-col bg-fixed bg-center relative inset-0 justify-center items-center text-center px-4"
            ...
            <div className="relative z-[110] grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 gap-y-[25vh]  p-4">
                ...
                <div className="flex flex-col items-center">
                    <img src="/exprealty.png" alt="eXp" className="w-[20vw] h-[25vh] object-cover" />
                ...
                <div className="flex flex-col items-center">
                    <img src="/advan.png" alt="advancing" className="w-[20vw] h-[25vh] object-cover" />
                ...
                <div className="flex flex-col items-center">
                    <img src="/abarca.png" alt="abarca" className="w-[20vw] h-[25vh] object-cover" />
                ...
                <div className="flex flex-col items-center">
                    <img src="/arescapital.png" alt="ares capital" className="w-[20vw] h-[25vh] object-cover" />
                ...
                <div className="flex flex-col items-center">
                    <img src="/duplo.png" alt="duplo" className="w-[20vw] h-[45vh] mt-[-25%] object-cover" />
                ...
                <div className="flex flex-col items-center">
                    <img src="/electry.png" alt="electry" className="w-[20vw] h-[25vh] object-cover" />
                ...
                <div className="flex flex-col items-center">
                    <img src="/mutua.png" alt="mutua" className="w-[20vw] h-[25vh] object-cover" />
                ...
                <div className="flex flex-col items-center">
                    <img src="/ordennails.png" alt="ordennails" className="w-[20vw] h-[25vh]  " />
                ...
                <div className="flex flex-col items-center">
                    <img src="/reformatek.png" alt="reformatek" className="w-[20vw] h-[25vh] mt-[0vh]" />
                ...
                <div className="flex flex-col items-center">
                    <img src="/suelosyparedes.png" alt="suelosyparedes" className="w-[20vw] h-[25vh]" />
                ...
                <div className="flex flex-col items-center">
                    <img src="/coocun.jpg" alt="suelosyparedes" className="w-[20vw] h-[25vh]" />
